...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Mohammed Shahal & Aysha Fasna — Wedding Invitation" },
      { name: "twitter:description", content: "Join us in celebrating the wedding of Mohammed Shahal & Aysha Fasna on 29th August 2026." },
